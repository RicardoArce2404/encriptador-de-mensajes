...
public class CifRsa extends AlgoritmoCifrado {
  ...
  /**
   * Genera un número primo aleatorio entre 1 y el valor dado por limiteGenerador.
   *
  ...
  /**
   * Genera un módulo, un exponente público y un exponente
   * privado para ser usados por el algoritmo de cifrado.
